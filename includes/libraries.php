<div id="library-type">
<legend>Select the appropriate type of production music library.</legend>
...
<div id="amount">
	<h2 class="commissioning-amount hidden">Commissioning Amount</h2>
		<p class="finished-track hidden">$1,250-$12,000</p>
		<p class="pro-payments hidden">$3,000-$25,000</p>
		<p class="libraries hidden">Production Music Libraries offer 
		...
		<p class="libraries hidden">While revenues are typically less 
